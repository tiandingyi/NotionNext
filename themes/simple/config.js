const CONFIG = {
  ...
  SIMPLE_LOGO_DESCRIPTION: process.env.NEXT_PUBLIC_THEME_SIMPLE_LOGO_DESCRIPTION || '<div>Chinese Metaphysics Enthusiast<br/>/DevOps<br/>/Knowledge-Sharing Blogger</div>',
